    ...
    <section className="w-full max-w-[90rem] mx-auto px-4 md:px-8 py-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
        ...
        <div className="relative group w-full lg:mt-12">
          ...
          >
            <div className="relative w-full h-32 sm:h-40 md:h-52 bg-slate-900">
               <Image 
            ...
            <div className="relative px-4 sm:px-5 pb-5">
               {/* ✅ ปรับ flex-col ในจอมือถือ ให้รูปกับข้อความไม่เบียดกัน */}
               <div className="flex flex-col sm:flex-row sm:items-end gap-3 sm:gap-4 -mt-10 sm:-mt-8 md:-mt-10">
                 
                 <div className="relative flex-shrink-0 z-10 self-start sm:self-auto ml-2 sm:ml-0">
                 ...
                 <div className="flex-1 w-full pt-2 sm:pt-0">
                    <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                        <div className="min-w-0"> 
                           <h3 className="text-xl md:text-2xl font-bold text-white flex items-center gap-2 leading-tight truncate">
                           Lemony
                           <CheckCircle className="text-blue-500 fill-blue-500 bg-white rounded-full flex-shrink-0" size={18} />
                           </h3>
                           <p className="text-slate-400 text-xs md:text-sm mt-1 truncate">@lemonyshop</p>
                        </div>

                        <div className="flex gap-2 w-full sm:w-auto mt-2 sm:mt-0 pb-1">
                           <div className="flex-1 sm:flex-none bg-blue-600 px-4 sm:px-5 h-10 rounded-lg flex items-center justify-center text-white font-bold text-xs sm:text-sm gap-2 whitespace-nowrap hover:bg-blue-500 transition-colors">
                              <ThumbsUp size={16} fill="currentColor"/> ถูกใจ
                           </div>
                           <div className="flex-1 sm:flex-none bg-[#3a3b3c] px-4 sm:px-5 h-10 rounded-lg flex items-center justify-center text-white font-bold text-xs sm:sm gap-2 whitespace-nowrap hover:bg-[#4e4f50] transition-colors">
